...
def clean_data(df):
    var = pd.get_dummies(df['property_type'], prefix=['Apartments', 'Houses'])
    var.rename(columns={"['Apartments', 'Houses']_Apartments": 'apartments', "['Apartments', 'Houses']_Houses":'houses'}, inplace = True)
...
def main():
    if len(sys.argv) == 4:
        ...
        print('Please provide the filepaths of the apartments and houses ' \
